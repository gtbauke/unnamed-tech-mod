...
public class ModCommonConfig {
    ...
    static {
        ...
        LEAD_ORE_VEINS_PER_CHUNK = BUILDER.comment("Lead Ore Veins per chunk").define("Veins per chunk", 7);
        LEAD_ORE_VEIN_SIZE = BUILDER.comment("Lead Ore Blocks in one vein").defineInRange("Vein Size", 9, 4, 20);
