...
public class BasicAlloySmelterMenu extends AbstractContainerMenu {
    public final BasicAlloySmelterEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public BasicAlloySmelterMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
        this(id, inventory, inventory.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public BasicAlloySmelterMenu(int id, Inventory inventory, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.BASIC_ALLOY_SMELTER_MENU.get(), id);
        checkContainerSize(inventory, 4);
        blockEntity = (BasicAlloySmelterEntity) entity;
